...
Más adelante se pueden añadir capturas de pantalla para cada paso.
...
3. Clonar el repositorio:
    ...
    ```
4. (Opcional) Abrir la carpeta en Visual Studio Code desde la terminal:

    code .

   Si el comando `code` no funciona, se puede abrir Visual Studio Code manualmente y usar  
   **File → Open Folder…** para seleccionar:
