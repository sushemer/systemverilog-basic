...
- Tu trabajo principal está en `hackathon_top.sv` (en `4_Activities`, `5_Labs` o `6_Implementation`).
...
Con este mapa mental deberías poder orientarte en cualquier carpeta del repositorio **sin perderte**.
